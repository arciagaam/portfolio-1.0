...
const Home = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-primary text-secondary scroll-smooth font-inconsolata uppercase">
            ...
            {/* SECTION 1 ABOUT ME */}
            <div id='about' className="relative flex flex-col p-5 md:p-20 min-h-screen justify-between">
                <div className='absolute flex flex-row gap-20 items-baseline top-20 left-5 md:left-20 text-white/20'>
                    <p className='font-inter font-bold text-9xl'>01</p>
                </div>

                <div className="flex mt-[13em] md:mt-0 flex-col md:flex-row flex-1 justify-center gap-20">
            ...
            {/* SECTION 2 TECHSTACK */}
            <div className="relative flex flex-col p-5 md:p-20 min-h-screen justify-between">
                <p className='absolute top-20 left-5 md:left-20 font-inter font-bold text-9xl text-white/20'>02</p>
            ...
            {/* SECTION 3 PROJECTS */}
            <div className="relative flex flex-col p-5 md:p-20 min-h-screen justify-between">
                <p className='absolute top-20 left-5 md:left-20 font-inter font-bold text-9xl text-white/20'>03</p>

                <div className="flex mt-[13em] md:mt-0 py-20 md:py-0 min-h-fit md:min-h-screen flex-1 justify-center">
                    <div className='flex flex-col items-center justify-center'>
                        <p className='font-inter font-bold text-6xl md:text-9xl'>Projects</p>
